package com.heller.eureka.client.provider;
...
public class ApplicationTests {
    ...
    public void shouldRegisterClientInEurekaServer() throws InterruptedException {
        ...
        ResponseEntity<String> response = testRestTemplate.getForEntity("http://localhost:" + port
                + "/service-instances/eureka-client", String.class);
